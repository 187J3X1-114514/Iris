...
val MINECRAFT_VERSION by extra { "26.2-pre-4" }
val NEOFORGE_VERSION by extra { "26.1.1.0-beta" }
val FABRIC_LOADER_VERSION by extra { "0.19.3" }
val FABRIC_API_VERSION by extra { "0.151.0+26.2" }

val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium").resolve("sodium-fabric-0.8.11-SNAPSHOT+mc26.2-pre-4-local.jar")) }
...
// https://semver.org/
val MOD_VERSION by extra { "1.10.9" }
